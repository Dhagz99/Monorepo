/*
  ...
  - The values [REACTIVATION_REQUEST] on the enum `NotificationEntityType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "NotificationEntityType_new" AS ENUM ('PROCEED_PAYMENT', 'CONFIRMED_PAYMENT', 'CONFIRMED_WITHDRAWAL', 'AGENT_REASSIGNMENT');
...
ALTER TYPE "NotificationType" ADD VALUE 'AGENT_REGISTRATION';
